...
from moloni.api.taxexemptions_client import (
    TaxexemptionsClient,
...
class TestTaxexemptionsClient(unittest.TestCase):
    def setUp(self):
        self.client = TaxexemptionsClient()

    @patch.object(TaxexemptionsClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = TaxexemptionsCountModifiedSinceModel(
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = TaxexemptionsGetModifiedSinceModel(
            lastmodified="lastmodified",
        )
