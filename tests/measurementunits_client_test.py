...
from moloni.api.measurementunits_client import (
...
class TestMeasurementunitsClient(unittest.TestCase):
    def setUp(self):
        self.client = MeasurementunitsClient()

    @patch.object(MeasurementunitsClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = MeasurementunitsCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = MeasurementunitsDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = MeasurementunitsGetAllModel(
            company_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = MeasurementunitsGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
        )
    ...
    def test_insert(self, mock_request):
        ...
        model_data = MeasurementunitsInsertModel(
            company_id="sample_value",
            name="name",
    ...
    def test_update(self, mock_request):
        ...
        model_data = MeasurementunitsUpdateModel(
            company_id="sample_value",
            name="name",
            short_name="short_name",
            unit_id="sample_value",
