...
from moloni.api.deliverymethods_client import (
...
class TestDeliverymethodsClient(unittest.TestCase):
    def setUp(self):
        self.client = DeliverymethodsClient()

    @patch.object(DeliverymethodsClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = DeliverymethodsCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = DeliverymethodsDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = DeliverymethodsGetAllModel(
            company_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = DeliverymethodsGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
        )
    ...
    def test_insert(self, mock_request):
        ...
        model_data = DeliverymethodsInsertModel(
            company_id="sample_value",
            name="name",
        )
    ...
    def test_update(self, mock_request):
        ...
        model_data = DeliverymethodsUpdateModel(
            company_id="sample_value",
            delivery_method_id="sample_value",
            name="name",
        )
