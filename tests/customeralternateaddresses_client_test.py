...
from moloni.api.customeralternateaddresses_client import (
...
class TestCustomeralternateaddressesClient(unittest.TestCase):
    def setUp(self):
        self.client = CustomeralternateaddressesClient()

    @patch.object(CustomeralternateaddressesClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = CustomeralternateaddressesCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = CustomeralternateaddressesDeleteModel(
            address_id="sample_value",
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = CustomeralternateaddressesGetAllModel(
            company_id="sample_value",
            customer_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = CustomeralternateaddressesGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
            offset="offset",
            qty="qty",
    ...
    def test_insert(self, mock_request):
        ...
        model_data = CustomeralternateaddressesInsertModel(
            address="address",
            city="city",
            code="code",
            company_id="sample_value",
    ...
    def test_update(self, mock_request):
        ...
        model_data = CustomeralternateaddressesUpdateModel(
            address="address",
            address_id="sample_value",
            city="city",
            code="code",
