...
from moloni.api.countries_client import (
    CountriesClient,
...
class TestCountriesClient(unittest.TestCase):
    def setUp(self):
        self.client = CountriesClient()

    @patch.object(CountriesClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = CountriesCountModifiedSinceModel(
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = CountriesGetModifiedSinceModel(
            lastmodified="lastmodified",
        )
