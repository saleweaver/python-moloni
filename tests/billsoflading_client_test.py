...
from moloni.api.billsoflading_client import (
    BillsofladingClient,
...
class TestBillsofladingClient(unittest.TestCase):
    def setUp(self):
        self.client = BillsofladingClient()

    @patch.object(BillsofladingClient, "_request")
    def test_count(self, mock_request):
        ...
        model_data = BillsofladingCountModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = BillsofladingDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = BillsofladingGetAllModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
            document_set_id="sample_value",
    ...
    def test_get_one(self, mock_request):
        ...
        model_data = BillsofladingGetOneModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
            document_id="sample_value",
    ...
    def test_insert(self, mock_request):
        ...
        model_data = BillsofladingInsertModel(
    ...
    def test_set_transport_code(self, mock_request):
        ...
        model_data = BillsofladingSetTransportCodeModel(
            company_id="sample_value",
            document_id="sample_value",
    ...
    def test_update(self, mock_request):
        ...
        model_data = BillsofladingUpdateModel(
            associated_documents=[],
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
