...
from moloni.api.subscription_client import SubscriptionClient, SubscriptionGetOneModel
...
class TestSubscriptionClient(unittest.TestCase):
    ...
    @patch.object(SubscriptionClient, "_request")
    def test_get_one(self, mock_request):
        ...
        model_data = SubscriptionGetOneModel(
