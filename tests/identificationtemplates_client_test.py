...
from moloni.api.identificationtemplates_client import (
...
class TestIdentificationtemplatesClient(unittest.TestCase):
    def setUp(self):
        self.client = IdentificationtemplatesClient()

    @patch.object(IdentificationtemplatesClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = IdentificationtemplatesCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = IdentificationtemplatesDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = IdentificationtemplatesGetAllModel(
            company_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = IdentificationtemplatesGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
        )
    ...
    def test_insert(self, mock_request):
        ...
        model_data = IdentificationtemplatesInsertModel(
            address="address",
            business_name="business_name",
            city="city",
            company_id="sample_value",
            country_id="sample_value",
            documents_footnote="documents_footnote",
            email="email",
    ...
    def test_update(self, mock_request):
        ...
        model_data = IdentificationtemplatesUpdateModel(
            address="address",
            business_name="business_name",
            city="city",
            company_id="sample_value",
