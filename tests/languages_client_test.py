...
from moloni.api.languages_client import (
    LanguagesClient,
...
class TestLanguagesClient(unittest.TestCase):
    def setUp(self):
        self.client = LanguagesClient()

    @patch.object(LanguagesClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = LanguagesCountModifiedSinceModel(
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = LanguagesGetModifiedSinceModel(
            lastmodified="lastmodified",
        )
