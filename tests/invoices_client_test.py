...
from moloni.api.invoices_client import (
    InvoicesClient,
    InvoicesCountModel,
    InvoicesDeleteModel,
    InvoicesGetAllModel,
...
class TestInvoicesClient(unittest.TestCase):
    def setUp(self):
        self.client = InvoicesClient()

    @patch.object(InvoicesClient, "_request")
    ...
    def test_delete(self, mock_request):
        ...
        model_data = InvoicesDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = InvoicesGetAllModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
            document_set_id="sample_value",
    ...
    def test_get_one(self, mock_request):
        ...
        model_data = InvoicesGetOneModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
            document_id="sample_value",
    ...
    def test_insert(self, mock_request):
        ...
        model_data = InvoicesInsertModel(
            alternate_address_id="sample_value",
    ...
    def test_update(self, mock_request):
        ...
        model_data = InvoicesUpdateModel(
            alternate_address_id="sample_value",
            associated_documents=[],
            company_id="sample_value",
            customer_id="sample_value",
