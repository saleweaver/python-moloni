...
from moloni.api.documents_client import (
    DocumentsClient,
    DocumentsCountModel,
...
class TestDocumentsClient(unittest.TestCase):
    def setUp(self):
        self.client = DocumentsClient()

    @patch.object(DocumentsClient, "_request")
    def test_count(self, mock_request):
        ...
        model_data = DocumentsCountModel(
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = DocumentsGetAllModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
            document_set_id="sample_value",
    ...
    @patch.object(DocumentsClient, "_request")
    def test_get_all_document_types(self, mock_request):
        # Mock the Response object
        mock_response = Mock(spec=Response)
        mock_response.json.return_value = {"some_key": "some_value"}
        mock_response.status_code = 200
        ...
        model_data = DocumentsGetAllDocumentTypesModel(
            language_id="sample_value",
        )
        response = self.client.get_all_document_types(data=model_data)
    ...
    def test_get_one(self, mock_request):
        ...
        model_data = DocumentsGetOneModel(
            company_id="sample_value",
            customer_id="sample_value",
            date="date",
    ...
    @patch.object(DocumentsClient, "_request")
    def test_get_pdf_link(self, mock_request):
        # Mock the Response object
        mock_response = Mock(spec=Response)
        mock_response.json.return_value = {"some_key": "some_value"}
        mock_response.status_code = 200
        ...
        model_data = DocumentsGetPdfLinkModel(
            company_id="sample_value",
            document_id="sample_value",
        )
        response = self.client.get_pdf_link(data=model_data)
