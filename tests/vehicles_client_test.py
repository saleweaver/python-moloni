...
from moloni.api.vehicles_client import (
    VehiclesClient,
...
class TestVehiclesClient(unittest.TestCase):
    def setUp(self):
        self.client = VehiclesClient()

    @patch.object(VehiclesClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = VehiclesCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = VehiclesDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = VehiclesGetAllModel(
            company_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = VehiclesGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
        )
    ...
    def test_insert(self, mock_request):
        ...
        model_data = VehiclesInsertModel(
            company_id="sample_value",
    ...
    def test_update(self, mock_request):
        ...
        model_data = VehiclesUpdateModel(
            company_id="sample_value",
            description="description",
            number_plate="number_plate",
            vehicle_id="sample_value",
