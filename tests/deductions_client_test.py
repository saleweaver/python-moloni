...
from moloni.api.deductions_client import (
    DeductionsClient,
...
class TestDeductionsClient(unittest.TestCase):
    def setUp(self):
        self.client = DeductionsClient()

    @patch.object(DeductionsClient, "_request")
    def test_count_modified_since(self, mock_request):
        ...
        model_data = DeductionsCountModifiedSinceModel(
    ...
    def test_delete(self, mock_request):
        ...
        model_data = DeductionsDeleteModel(
            company_id="sample_value",
    ...
    def test_get_all(self, mock_request):
        ...
        model_data = DeductionsGetAllModel(
            company_id="sample_value",
        )
    ...
    def test_get_modified_since(self, mock_request):
        ...
        model_data = DeductionsGetModifiedSinceModel(
            company_id="sample_value",
            lastmodified="lastmodified",
        )
    ...
    def test_insert(self, mock_request):
        ...
        model_data = DeductionsInsertModel(
            company_id="sample_value",
            name="name",
            value="value",
        )
    ...
    def test_update(self, mock_request):
        ...
        model_data = DeductionsUpdateModel(
            company_id="sample_value",
            deduction_id="sample_value",
            name="name",
            value="value",
